/**
 * Common MSP workflows with recommended tool usage.
 */
export function getWorkflowsDoc(): string {
  const lines = [
    ...
    'Parameters: {',
    '  site: "Acme Corp",',
    '  status: "offline",  // or "online" or "all"',
    '  has_alerts: true',
    '}',
    '```',
    '',
    ...
    'Parameters: {',
    '  site: "Acme Corp",  // or omit for account-wide',
    '  group_by: "type",',
    '  time_range: "week"',
    '}',
    '```',
    ...
    'Parameters: {',
    '  site: "Acme Corp",',
    '  type: "server",  // filter by type',
    '  status: "online"  // only online devices',
    '}',
    '```',
    '',
    ...
    'Parameters: {',
    '  site: "Acme Corp",',
    '  devices: "all",  // or array of specific devices',
    ...
    'Parameters: {',
    '  query: "web-server",',
    '  has_alerts: true  // optional: only devices with alerts',
    '}',
    '```',
    '',
    '**What you\'ll get:**',
    ...
    'Parameters: {',
    '  device: "web-server-01",',
    '  site: "Acme Corp"  // from search results',
    '}',
    '```',
    '',

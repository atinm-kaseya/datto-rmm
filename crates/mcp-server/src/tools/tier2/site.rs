    ...
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let devices_data = client
                .list_site_devices(&params.site_uid, Some(datto_api::PaginationQuery {
                    page: params.page,
                    max: params.max,
                }))
                .await
    ...
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let alerts_data = client
                .list_site_open_alerts(&params.site_uid, Some(datto_api::PaginationQuery {
                    page: params.page,
                    max: params.max,
                }))
                .await
...
pub fn get_site_settings_handler() -> ToolHandler {
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let settings = client
                .get_site_settings(&params.site_uid)
                .await
    ...
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let variables = client
                .list_site_variables(&params.site_uid, Some(datto_api::PaginationQuery {
                    page: params.page,
                    max: params.max,
                }))
                .await
...
pub fn list_site_resolved_alerts_handler() -> ToolHandler {
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let data = client
                .list_site_resolved_alerts(&params.site_uid, Some(datto_api::PaginationQuery {
                    page: params.page,
                    max: params.max,
                }))
                .await
...
pub fn create_site_handler() -> ToolHandler {
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let site = client.create_site(&request).await
...
pub fn update_site_handler() -> ToolHandler {
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            // First get the existing site
            let mut site = client.get_site(&params.site_uid).await
                .map_err(|e| crate::Error::Api(format!("Failed to get site: {}", e)))?;
            ...
            let updated = client.update_site(&params.site_uid, &site).await
...
pub fn list_site_filters_handler() -> ToolHandler {
    Box::new(|client: Arc<DattoClient>, args: Value| {
        Box::pin(async move {
            ...
            let data = client.list_site_filters(&params.site_uid, None).await
